...
# about your device
export DEVICE="X688B" # codename used in device tree
export DT_LINK="https://github.com/Gokkuken/twrp_infinix_X688B" # device tree link
export DT_BRANCH="11" # device tree branch
